      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-start">
        ...
        <div className="lg:col-span-7 space-y-10">
          ...
          <section className="space-y-6">
            <p className="text-lg text-neutral-800 font-light leading-relaxed serif italic border-l-2 border-neutral-200 pl-8">
          ...
          <section className="pt-8 border-t border-neutral-100">
            <h3 className="text-[16px] tracking-[0.4em] uppercase text-neutral-400 mb-6 font-medium">Core Strengths 核心特質</h3>
          ...
          <section className="pt-8 border-t border-neutral-100 space-y-6">
            <h3 className="text-[16px] tracking-[0.4em] uppercase text-neutral-400 font-medium">Professional Experience 實務經驗</h3>
            <div className="text-neutral-600 font-light leading-relaxed space-y-4">
              ...
              <div className="bg-neutral-50 p-6 rounded-sm border-l-2 border-neutral-200">
                <h4 className="text-[16px] text-neutral-900 font-medium mb-4">專業工具 Professional Tools</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-1">
                    <span className="text-[14px] uppercase tracking-widest text-neutral-800 block">[3D建模與製圖]</span>
                    <p className="text-sm text-neutral-800 leading-relaxed">
                      Revit, AutoCAD, Rhino, SketchUp
                    </p>
                  </div>
                  <div className="space-y-1">
                    <span className="text-[14px] uppercase tracking-widest text-neutral-800 block">[排版與渲染]</span>
                    <p className="text-sm text-neutral-800 leading-relaxed">
          ...
          <section className="pt-8 border-t border-neutral-100">
            <h3 className="text-[16px] tracking-[0.4em] uppercase text-neutral-400 mb-4 font-medium">Education 學歷教育</h3>
            <ul className="space-y-3">
              <li className="flex justify-between items-baseline border-b border-neutral-50 pb-3">
                ...
                <span className="text-sm text-neutral-500 italic">Master</span>
              </li>
              <li className="flex justify-between items-baseline border-b border-neutral-50 pb-3">
                <span className="text-base tracking-wide text-neutral-800">逢甲大學 - 建築學系</span>
                <span className="text-sm text-neutral-500 italic">Bachelor</span>
              </li>
            </ul>
          </section>
        </div>
